...
\begin{center}
    ...
    \small 682-551-2632 $|$ \href{mailto:x@x.com}{\underline{wxv5045@mavs.uta.edu}} $|$ 
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Bachelor of Arts in Computer Science}{Aug. 2021 -- Present}
    ...
    \resumeSubHeadingListStart
      \resumeProjectHeading
          ...
          \resumeItemListStart
            ...
            \resumeItem{Implemented hands-on projects in Python using Google Colab, focusing on letter and face recognition}
            \resumeItem{Gained basic experience with Keras and Tensorflow to train neural networks pattern recognition applications}
